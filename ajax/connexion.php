...
if($valider){
  ...
  $technologies = new Technologie_Modele();
  ...
  //On charge les planetes du joueur
  ...
  //On charge les technologies
  $_SESSION["joueur"]->setTechnologies($technologies->loadTechnologies($id));
